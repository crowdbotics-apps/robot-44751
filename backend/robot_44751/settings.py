"""
Django settings for robot_44751 project.
...
WSGI_APPLICATION = 'robot_44751.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "robot_44751 API",
    "DESCRIPTION": "API documentation for robot_44751 App",
    "VERSION": "v1",
}
